<footer class="apple-footer">
    <div class="container">
        ...
        <div class="footer-bottom border-top pt-4 pb-4">
            <div class="row">
                <div class="col-md-6 text-center text-md-left">
                    <p class="copyright">Copyright © <?php echo date('Y')?> Miggo Solutions S.A. Todos los derechos reservados.</p>
                </div>
                <div class="col-md-6 text-center text-md-right">
                    <p class="footer-credit">Desarrollado por <strong>Miggo Solutions</strong></p>
                </div>
            </div>
        </div>
    </div>
